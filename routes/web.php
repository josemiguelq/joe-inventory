...
Route::get('/products-shopping', function () {
    return view('shopping.products-index');
});

Route::get('/product/{id}', function ($id) {
    $ref = \App\Models\Reference::with('products')->find($id);
    return view('shopping.product',
        ['reference' => $ref,
        'products' => $ref->products()->with('product')->get()]);
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/products/addReference', [ProductController::class, 'addReference'])->name('products.addReference');
